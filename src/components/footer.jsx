...
function Footer(){
    return(
<footer class="bg-slate-300 text-center lg:text-left dark:bg-black  dark:text-white ">
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <div class="">
        ...
        <p>
        Plan your trip with us to experience things you've never heard of before :)     
           </p>
      </div>
      ...
      <div class="">
        ...
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Tours</a>
        </p>
        <p class="mb-4">
      ...
      <div class="">
        ...
        <p class="flex items-center justify-center md:justify-start mb-4">
          ...
          <a href ='tel:+255712876876'>+255 712 876 876</a>
        </p>
      </div>
  ...
  <div class="text-center p-4 bg-zinc-900" >
    © 2022 Copyright:
    Mandinga Travels
  </div>
</footer>
